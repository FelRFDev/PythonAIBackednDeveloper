...
class Conta:
    ...
    def __str__(self):
        return f'Class Name: {self.__class__.__name___} / Att: {", ".join(["{key} - {value}" for (key, value) in self.__dict__.items()])}'
    ...
    def __ver_saldo(self):
        operacao = 'Exibir Saldo'
        return self.__saldo, operacao  #retorna uma Tupla com os valores da variável saldo e da operacao
